...
class _MyHomePageState extends State<MyHomePage> {
 Tab currentTab = Tab.values.first;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        Row(children: [
          for (Tab tab in Tab.values) TextButton(onPressed: () => setState(() => currentTab = tab
            
          ), child: Text(tab.name, style: TextStyle(color: tab == currentTab ? Colors.blue : Colors.black)))
          ]
          ,),

          if (currentTab == Tab.links) ...[
            LinksTab(),
          ],
          if (currentTab == Tab.deals) ...[
            DealsTab(),
          ]
